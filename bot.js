...
const CHANNEL = '@EGIIIU'; // القناة المستهدفة
...
const GITHUB_REPO = process.env.GITHUB_REPO; // بصيغة "user/repo"
...
function log(msg) {
  ...
  console.log(line);
  logLines.push(line);
  if (logLines.length > 100) logLines.shift(); // نحتفظ بآخر 100 سطر فقط
}

// ---------- البصمات (محلية + مزامنة GitHub) ----------
let seenHashes = new Set();

// تحميل البصمات من الملف المحلي
